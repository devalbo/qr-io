...
//     if (isCleaningUp || webScannerRef.current) return;
...
//       try {
//         // Stop scanner first
//         if (typeof webScannerRef.current.stop === 'function') {
//           webScannerRef.current.stop().catch((error: any) => {
...
//       try {
//         // Clear scanner
//         if (typeof webScannerRef.current.clear === 'function') {
...
//     //     containerElement.innerHTML = '';
//     //   } catch (error) {
//     //     console.log('Container cleanup error:', error);
//     //   }
//     // }

//     // Remove custom CSS safely
//     // try {
//     //   const customStyles = document.querySelectorAll('style');
//     //   customStyles.forEach(style => {
//     //     if (style.textContent?.includes('html5-qrcode-button-camera-stop')) {
//     //       try {
//     //         style.remove();
//     //       } catch (error) {
//     //         console.log('Style removal error:', error);
//     //       }
//     //     }
//     //   });
//     // } catch (error) {
